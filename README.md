...
Each time you visit the page click the Bookmarklet to activate it. Alternativly on the printer replace /app/resources/www/index.html with the index_patches.html file within the html folder, or apply the provided patch.   
